...
public class MB_NEFT_AddBenefiary extends MB_BaseClass
{
      @Test(priority =1)
      public void AddBeneficialry() throws IOException, InterruptedException
      {
    	  XSSFSheet sheet = workbook.getSheet("MB_NEFT_AddBeneficiary"); 
      ...
      public void NEFTERequest() throws InterruptedException
      {
    	  driver.findElement(By.xpath(p.getProperty("FundTransferOtherBank"))).click();
 	  	  driver.findElement(By.xpath(p.getProperty("NEFT_ERequest"))).click();
    	  driver.findElement(By.xpath(p.getProperty("MB_NEFTERequest"))).click();
    	  Thread.sleep(2000);
